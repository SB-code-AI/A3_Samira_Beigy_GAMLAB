...
print(f'MAP error for LR is:{mape_train_score_LR}')
#
#---------------------------------------------------------------------
#
#
...
# print(f'MAP error for KNN is:{mape_train_score_knn}')
best_params = grid_search.best_params_
best_score = grid_search.best_score_
print(f'Best parameters for KNN: {best_params}')
print(f'Best MAE score during cross-validation: {best_score}')
...
# model =  DecisionTreeRegressor(max_depth=3,random_state=43,min_samples_split=int(0.25 * len(dt_x_train)),criterion='squared_error')
# #------------------------Step 3_FITTING-------------------------------
# model.fit(dt_x_train, dt_y_train)
# #------------------------Step 4-Prediction----------------------------
# dt_y_pred = model.predict(dt_x_test)
# #------------------------Step 5-Evaluation----------------------------
# mae_test_score_desicion_tree_squared_error = mean_absolute_error(dt_y_test, dt_y_pred)
# print(f'MAE error for Decision Tree with squared_error is: {mae_test_score_desicion_tree_squared_error}')
# mape_train_score_desicion_tree_squared_error=mean_absolute_percentage_error(dt_y_test,dt_y_pred)
# print(f'MAP error for Desicion Tree with squared_error is:{mape_train_score_desicion_tree_squared_error}')
#
#---------------------------------------------------------------------
#
#
